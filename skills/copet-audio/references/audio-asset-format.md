...
Rules **established by `copet-audio`** (no upstream source). Source of truth for audio asset format requirements for clips generated by the audio pack workflow.
