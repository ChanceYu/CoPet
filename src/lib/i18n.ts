...
const messages = {
  "en-US": {
    ...
    pauseResponse: "Pause reactions",
    pauseResponseDescription: "Freeze the pet on its current pose until reactions are resumed.",
    pets: "Pets",
  ...
  "zh-CN": {
    ...
    pauseResponse: "暂停响应",
    pauseResponseDescription: "保留宠物当前姿态，直到恢复响应。",
    pets: "宠物",
