...
const messages = {
  "en-US": {
    ...
    agentIntegrationsLead:
      "Toggle a CLI on and CoPet installs a tiny hook that mirrors its live status onto your desktop pet.",
    ...
    localImportChoice: "Choose local source",
    language: "Language",
    ...
    selectPreviewPet: "Select preview pet",
    size: "Pet size",
    zhCn: "中文",
  },
  "zh-CN": {
    ...
    agentIntegrationsLead:
      "开启后 CoPet 会安装一个轻量钩子，把该 CLI 的实时状态同步到桌面宠物上",
